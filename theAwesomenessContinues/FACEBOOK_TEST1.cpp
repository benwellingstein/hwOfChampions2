...
void test1(){
	...
	if (DS.trainingGroupFight(0,2,3,3)== FAILURE) exeption++; //Team 2 is not Active
	...
	if (DS.trainingGroupFight(0,1,1,1) == FAILURE) exeption++; //Team 1 is not Active
	...
	if ( DS.trainingGroupFight(0,3,1,1) == FAILURE) exeption++; //Team 0 is not Active
	...
	if ( DS.trainingGroupFight(5,3,1,1)== FAILURE) exeption++; //Team 5 is not Active
	...
	if (DS.trainingGroupFight(4,3,1,1)==FAILURE) exeption++; //Team 3 is not Active
